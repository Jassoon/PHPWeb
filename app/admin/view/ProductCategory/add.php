...
<div class="content">
    <form action="<?php echo url('ProductCategory-insert'); ?>" method="post">
        <table class="edit">
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input name="orderly" type="text" data-type="float" value="<?php echo D('product_category')->getAutoincrement();?>" size="6" maxlength="6">
