...
<div class="content">
    <form action="<?php echo url('FileCategory-insert'); ?>" method="post">
        <table class="edit">
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input name="orderly" type="text" data-type="float" value="<?php echo D('File_category')->getAutoincrement(); ?>" size="6" maxlength="6">
