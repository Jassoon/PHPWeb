    ...
    <?php if($rows){ ?>
        ...
        <table class="list">
            ...
            <tr align="center">
                ...
                <td align="left"><a title="编辑" href="<?php echo url('FileCategory-edit', $row['id']); ?>"><?php echo $row['cat_name']; ?></a></td>
                <td><?php echo $sum; ?></td>
                <td><?php echo $row['id']; ?></td>
                <td width="30"><a href="<?php echo url('FileCategory-edit', $row['id']); ?>">编辑</a></td>
                <td width="30"><?php if(!$sum && $this->auth(CONTROLLER, 'del')){ ?><a class="del" href="<?php echo url('FileCategory-del', $row['id']); ?>">删除</a><?php } ?></td>
                <td></td>
            </tr>
            <?php } ?>
        </table>
