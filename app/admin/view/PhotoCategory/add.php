...
<div class="content">
    <form action="<?php echo url('PhotoCategory-insert'); ?>" method="post">
        <table class="edit">
            <tr>
                <td align="right" width="60">名称：</td>
                <td><input name="cat_name" type="text" size="35" maxlength="30" autofocus required title="请输入类别名称"></td>
            </tr>
            <tr>
                <td align="right">排序：</td>
                <td>
                    <input name="orderly" type="text" data-type="float" value="<?php echo D('photo_category')->getAutoincrement();?>" size="6" maxlength="6">
            ...
            <tbody id="seo" style="display: none;">
                <tr>
                    <td align="right" valign="top">标题栏：</td>
