<div class="tab-bar">
    <ul class="tab">
        ...
        <li class="tab-item current"><a href="<?php echo SELF_URL; ?>">文章列表</a></li>
    </ul>
</div>
<div class="content">
    <form>
    ...
    <form method="post" id="listForm">
        <table class="list">
            ...
            <tr align="center">
                ...
                <td align="left"><a title="编辑" href="<?php echo url('Article-edit', $row['id']); ?>"><?php echo $row['title']?></a></td>
                <td align="left"><?php echo $row['cat_name'];?></td>
                <td><span class="right" data-href="<?php echo url('Article-ajax-show', $row['id']); ?>" data-val="<?php echo $row['is_show']; ?>"></span></td>
                <td><span class="right" data-href="<?php echo url('Article-ajax-tj', $row['id']); ?>" data-val="<?php echo $row['is_tj']; ?>"></span></td>
                <td><?php echo $row['create_date'];?></td>
                <td width="30"><a href="<?php echo url('Article-edit', $row['id']); ?>">编辑</a></td>
                <td width="30"><a class="del" href="<?php echo url('Article-del', $row['id']); ?>">删除</a></td>
            </tr>
            <?php } ?>
        </table>
    </form>
