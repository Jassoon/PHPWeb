<div class="tab-bar">
    <ul class="tab">
        ...
        <li class="tab-item"><a href="<?php echo url('ArticleCategory-add'); ?>">添加类别</a></li>
        <?php } ?>
    ...
    <ul class="context">
        <li><?php if($prev){ ?><a href="<?php echo url('ArticleCategory-edit', $prev['id']); ?>" data-target="replace">上一条</a><?php } ?></li>
        <li><?php if($next){ ?><a href="<?php echo url('ArticleCategory-edit', $next['id']); ?>" data-target="replace">下一条</a><?php } ?></li>
    </ul>
</div>
<div class="content">
    <form action="<?php echo url('ArticleCategory-update'); ?>" method="post">
        <table class="edit">
            <tr>
